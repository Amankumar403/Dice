...
class ThreeDiceScreen extends StatefulWidget {
  const ThreeDiceScreen({super.key});

  @override
  State<ThreeDiceScreen> createState() => _ThreeDiceScreenState();
}

class _ThreeDiceScreenState extends State<ThreeDiceScreen> {
            ...
            children: [
             ...
             Container(
               ...
               child:  TextButton(
                 ...
                 child: Image(image: AssetImage("images/dice$bottomDiceNumber.png",)),
               ),
             )
            ],
          )
